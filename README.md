...
The full paper is available in `writing/article.md` and as a formatted document at [link]. It is intended as a pre-doctoral research writing sample demonstrating familiarity with applied microeconomics methods, reproducible empirical workflows, and honest communication of identification assumptions and data limitations.
